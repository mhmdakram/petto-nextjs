...
export async function POST(req) {
    try {
        ...
        const adminEmail = "wafamuhammedas@gmail.com"; // Replace with actual admin email

        // ✅ Configure Nodemailer transporter
        const transporter = nodemailer.createTransport({
            service: "Gmail",
            auth: {
                user: "hellofrompetto@gmail.com", // Your email
                pass: "rtin cbbv qish afnv",   // Your email password
            },
        });

        // ✅ Email to Admin
        await transporter.sendMail({
            from: "hellofrompetto@gmail.com",
            to: adminEmail,
